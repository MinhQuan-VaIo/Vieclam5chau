...
<div id="body" class="footer w100 fl top-20">
    <h1 style="text-align: center; color: #5858FA;" >Danh Sách Việc Làm Xuất Khẩu Lao Động Tại Hàn Quốc<h1>
     <div class="col-md-12 col-xs-12">
        <div class="col-dk-3 col-md-3 col-xs-12">
        <input type="text" class="form-control show-select" id="chose-option-diemden-empty" placeholder="Lọc theo tên công việc"maxlength="200">


        </div>
        <div class="col-dk-3 col-md-3 col-xs-12"style = "margin-top: 10px; ">
        <select class="form-control show-select" id="chose-option-nganh-empty">
          
          <option value="">Lọc theo tỉnh/thành phố/bang</option>
        ...
        <select class="form-control show-select" id="chose-option-nganh-empty">
          ...
          <option value="">Lọc theo quận/huyện/hạt</option>
        ...
        <button id = "searchxkld"class="searchxkld">Tìm kiếm <i class="fa fa-search" aria-hidden="true"></i></button>
        </div>
     </div>


     <div class="col-md-4 col-xs-12">
     <img src="imgs/gangwon.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/bacchungcheong.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/namchungcheong.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
        <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Gangwon </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>

     </div>
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Bắc Chungcheong </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
     ...
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Nam Chungcheong </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
     ...
     <div class="col-md-4 col-xs-12">
     <img src="imgs/gyeonggi.webp" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/bacgyeongsang.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/namgyeongsang.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
        <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Gyeonggi </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>

     </div>
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Bắc Gyeongsang </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
     ...
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại Tỉnh Nam Gyeongsang </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
