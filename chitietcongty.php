...
<div class="col-md-12 col-xs-12 bx-content-lst-tour1">
            ...
            <div class="min-h-[112px] p-2 relative bg-white leading-6 rounded border border-solid hover:shadow-sd-hover hover:border-se-accent-100 hover:border-opacity-50 border-se-blue-10">
                <a data-track-content="" data-content-name="vl24h.jobbox.searchPage_suggestJob" data-content-piece="200326866_1_1"  class="flex relative w-full h-full flex-col" target="_blank" >
                    <div class="image-with-text" title="Chuyên Viên Đào Tạo">
                        <img alt="" src="imgs/anhlogo6.png">
                        <div class="text-content">
                            <h5 class="text-se-neutral-64 text-12 leading-6 truncate mb-0 font-normal max-w-[500px] lg:max-w-[530px]" role="button">
                             Nhà Hàng Lotus Garden
                            </h5>
                            <h2 class="text-se-neutral-64 text-12 leading-6 truncate mb-2 font-normal max-w-[500px] lg:max-w-[530px]" role="button">
                            Nhân Viên Phục Vụ
                            </h2>
        ...
        <div class="modal-content">
            ...
            <div class="col-md-12 col-xs-12 ">
                            ...
                            <button class="create-button"><i class="fa fa-plus" aria-hidden="true"></i>Tạo Hồ Sơ Trực Tuyến</button>
                           </div>
                           <div class="col-md-6 col-xs-12 ">
   
                           <button class="download-button"><i class="fa fa-download" aria-hidden="true"></i>Tải Lên Hồ Sơ Có Sẳn</button>
            ...
            <h5 class="dieukhoan">Bằng việc nhấn nút nộp hồ sơ , tôi đồng ý chia sẻ thông tin cá nhân với nhà tuyển dụng theo các điều khoản sử dụng , chính sách bảo mật và chính sách dữ liệu cá nhân của Việc Làm Năm Châu</h5>
    ...
    <!-- style=" background-color: #EFF8FB;" -->
        ...
        <form id="account-form" style="margin-top:20px;"action="db/thongtintaikhoan.php" method="post" enctype="multipart/form-data">
            <!--<form >-->
...
<div style="display: flex; align-items: center;margin-top: 30px;">
    ...
    <div>
        ...
        <p style="color: blue;">Bán hàng kinh doanh / Quản lý dự án / Phân tích - Thống kê dữ liệu</p> 
    </div>
</div>
...
<h3 style = " margin-top: 40px; margin-left: 40px;">Mô tả công việc<h2>
   ...
   <h5 style = " margin-top: 40px; margin-left: 40px;" id="mota_congviec">
      ...
      <h3 style = " margin-top: 40px; margin-left: 40px;">Địa chỉ làm việc<h2>
    ...
    <div class="tab-content" id="tab-company">
       ...
       <div style="display: flex; align-items: center;margin-top: 30px;">
     <h3>Nhà Hàng</h3>   <a href="#" style ="color: blue;margin-left: 400px;">Xem trang công ty <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
       
         
     </div>
     <div style="display: flex; align-items: center;margin-top: 30px;">
     <span style="opacity: 0.5; margin-left: 20px;">   <i class="fa fa-map-marker" aria-hidden="true"></i> Địa chỉ:</span>
    <span style=" margin-left: 20px;">Địa chỉ</span>
     </div>
     <div style="display: flex; align-items: center;margin-top: 30px;">
     <span style="opacity: 0.5; margin-left: 20px;">  <i class="fa fa-users" aria-hidden="true"></i>Quy mô:</span>
    <span style=" margin-left: 20px;"> 100 - 150 người</span>
     </div>
...
<div class="menuu" style = "width:30%;">
        <h1>Duy đẹp trai hìhehfhdfdjjdjldjjfjjdfjkvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv</h1>
        </div>
