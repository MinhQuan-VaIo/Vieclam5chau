...
<form id ="formb3">
 ...
 <button class="listBtn3" onclick="toggleForms3(this)"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu</button>
        ...
        <h2 style= "color: #08088A;">Hồ Sơ Ứng Tuyển</h2>
<div style="display: flex; align-items: center; margin-top 40px;">
   
    <h3 style="margin-left: 10px;margin-top:60px;">
Tất cả tin đăng <span style="color:red;"> (273 hồ sơ nộp) </span></h3>

<span style="margin-left: 50px;margin-top:60px;"><i class="fa fa-exclamation-circle" aria-hidden="true" style="color: #F7D358;"></i>
Hồ sơ bị xoá hoặc ẩn bởi ứng viên sẽ không thể tải xuống.</span>
...
<div>Lọc vị trí:</div>
<div class="form-group col-dk-4 col-md-4 col-xs-12">
...
<div class="form-group col-dk-3 col-md-3 col-xs-12">
    ...
    <select class="form-control show-select" id="chose-option-nganh-empty">
<option value="">Tất cả thời gian nộp</option>
...
<div class="form-group col-dk-3 col-md-3 col-xs-12">
    ...
    <select class="form-control show-select" id="chose-option-nganh-empty" style = "  background-color: #81F7F3;">
<option value="" > Lọc nâng cao(0)</option>
...
<div style="display: flex; align-items: center; margin-top 40px;">Bạn đã chọn (
<span id="hoso_number" class="hoso_number" name ="hoso_number" style = "color: red;">0</span> ) hồ sơ
</div>

<form id ="formtindang" name="formtindang">
<div style="display: flex; align-items: center;margin-top: 30px;">
<input type="checkbox" id="tick_hoso"style = "margin-left: 30px;"  >
    <label for="hoso" style = "margin-left: 5px; margin-top:8px;"> Tên hồ sơ</label>
    <label for="vịtri" style = "margin-left: 60px; margin-top:8px;"> Vị trí ứng tuyển </label>
    <label for="thoihannop" style = "margin-left: 60px; margin-top:8px;"> Thời hạn nộp </label>
    <label for="loaihoso" style = "margin-left: 60px; margin-top:8px;"> Loại hồ sơ </label>
    <label for="nguonhoso" style = "margin-left:60px; margin-top:8px;"> Nguồn hồ sơ </label>
    <label for="trangthaituyendung" style = "margin-left: 60px; margin-top:8px;"> Trạng thái tuyển dụng </label>
</div>
<div class="line" style ="margin-top: 20px;"></div>
<div style="display: flex; align-items: center;margin-top: 30px;">
<input type="checkbox" id="tick_chitiethoso"style = "margin-left: 30px;"  >
