...
<form id ="formb3">
 ...
 <button class="listBtn3" onclick="toggleForms3(this)"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu</button>
        ...
        <form id ="forma2" action="clash.taotin.php" method="post">
            <h2 style = " color: #5882FA;"> Danh sách đơn hàng</h2>
        ...
        <span class="soluong" id="number1"></span>
        Số lần mua dịch vụ 
    </div>
    <div class="boxxx damua">
        <span class="soluong" id="number2"></span>
        Tổng gói đã mua
    </div>
    <div class="boxxx chuakichhoat">
        <span class="soluong" id="number3"></span>
        Số gói chưa kích hoạt
    </div>
...
<div style="display: flex; align-items: center; margin-top 40px;"> 
<h4 style ="margin-top:40px;">Danh sách dịch vụ</h4>
<button class="dangkydichvu-btn" id="dangkydichvu-btn">Đăng ký dịch vụ</button>
</div>


<div class="col-md-12 col-xs-12 " style ="margin-top:40px;" >
<div class="col-dk-4 col-md-4 col-xs-12 " >
<input type="text" class="form-control show-select" id="chose-option-diemden-empty" placeholder="Nhập mã dịch vụ e.g 20006584" name="ma_dich_vu">
</div>
...
<div class="col-dk-2 col-md-2 col-xs-12 " >
<select class="form-control show-select" id="chose-option-hinhthu-empty" name="hinh_thuc_lam_viec">
<option value=""> Trạng thái gói</option>
          <option value="het_han"> Đã kích hoạt </option>
          <option value="con_han"> Chưa kích hoạt </option>
       
          </select>
</div>
<div class=" col-dk-2 col-md-2 col-xs-12">
<button id="downloadExcel"><i class="fa fa-file-text" aria-hidden="true"></i>Xuất Excel</button>
...
<div style="margin-top: 140px; border: 0.5px solid black; padding: 20px;">
<div style="display: flex; align-items: center; margin-top 40px;"> 
<div>MP - 200001010</div>
<button id="chitiet" style="margin-left: 680px;">Chi Tiết Kích Hoạt <i class="fa fa-arrow-right" aria-hidden="true" style="color:blue;"></i> </button>


</div>
<div style="display: flex; align-items: center; margin-top 20px;"> 
<div> Ngày ghi nhận: <soan style ="color:green;"> 10/03/2024 </span></div>
<div> - Hạn sử dụng: <soan style ="color:green;"> 15/03/2024 </span></div>
 <div style = "color:red;"> (<span style = "color:red; " id ="trangthai">Đã hết hạn</span> )</div>


</div>
<div style="display: flex; align-items: center; margin-top 20px;"> 
<div> Ngày tạo: <soan style ="color:green;"> 15/03/2024 </span></div>
</div>
<div style="display: flex; align-items: center; margin-top 20px;  background-color: #D8D8D8;"> 
<div>Tên dịch vụ </div>
<div style = "margin-left: 350px;">Số lượng </div>
<div style = "margin-left: 70px;">Thời gian </div>
<div style = "margin-left: 70px;">Đã kích hoạt </div>
<div style = "margin-left: 70px;">Chưa kích hoạt</div>
</div>
<div style="display: flex; align-items: center; margin-top: 20px;"> 
<div>Đăng tin tiêu chuẩn </div>
<div style = "margin-left: 320px;">5 tin </div>
<div style = "margin-left: 100px;">4 tuần </div>
<div style = "margin-left: 90px;">4 tin </div>
<div style = "margin-left: 130px;">1 tin</div>
</div>
