...
<form id ="formb3">
 ...
 <button class="listBtn3" onclick="toggleForms3(this)"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu</button>
        ...
        <h3 style = " color: black;"> Thông tin doanh nghiệp </h3>
        <a href="" style="color:blue;"> <i class="fa fa-question-circle-o" aria-hidden="true"></i> Hướng dẫn cập nhật thông tin </a>
        </div>
        <div id ="forma2" action="" method="post" style ="background-color: #f2f2f2;">
  
        
        <div class="horizontal-line1"></div>
       

        <div style="margin-top: 40px;width:80%; margin-left: 80px; ">
        <h4 style = "margin-bottom: 20px;">Giới thiệu doanh nghiệp </h4>

        <textarea id="gioi_thieu_danh_nghiep" name="gioi_thieu_danh_nghiep"  placeholder="Giới thiệu sơ lược về Công ty."></textarea>
       
        </div>
        <div style="display: flex; align-items: center; justify-content: space-between;margin-top:80px;width:88%;">
        <div style="margin-left: 40px;margin-right: 40px;">Website </div>
        <input type="text" class="form-control show-select" id="chose-option-diemden-empty" placeholder="https://quoctai.site">
        </div>
        <button class="capnhat_gioithieu" style="background-color: #8a2be2;color: #fff; margin-top:80px;margin-left:680px; width: 200px; height: 50px;">Cập Nhật</button>
...
<script>
    ClassicEditor
        .create(document.querySelector('#gioi_thieu_danh_nghiep'))
        .then(mo_ta_cong_viec => {
            console.log(mo_ta_cong_viec);
        })
        .catch(error => {
