...
<form id ="formb3">
 ...
 <button class="listBtn3" onclick="toggleForms3(this)"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu</button>
        ...
        <h2 style= "color: #08088A;">Danh Sách Tin Đăng</h2>
<div style="display: flex; align-items: center; margin-top 40px;">
    <button class="taotin" style="background-color: #08088A;margin-left: 20px;margin-top:60px;color: white; padding: 10px 15px; border: none; border-radius: 3px; font-size: 14px; width: auto;">Tạo Tin Đăng</button>
    <span style="margin-left: 300px;margin-top:60px;"><i class="fa fa-exclamation-circle" aria-hidden="true" style="color: #F7D358;"></i>
Để đảm bảo tin hợp lệ, tham khảo <a href="#">Quy định tin tuyển dụng</a> tại Việc làm tại năm châu</span>
</div>
<div style="display: flex; align-items: center;">
<h4>Thống kê tin :</h4> 
<div class="containertin" style = "margin-top:40px;">
<div class="boxx red">
...
<option value="1">Tin không phí </option>
<option value="1">Tin có phí </option>
...
<div class="form-group col-dk-2 col-md-2 col-xs-12">
<button id="downloadButton"><i class="fa fa-file-text" aria-hidden="true"></i>Tải Danh Sách</button>
...
<div style="display: flex; align-items: center;">
<div style="margin-left: 5px;">Tên tin đăng </div>
<div style="margin-left: 180px;">Ngày đăng </div>
<div style="margin-left: 40px;">Thời hạn nộp </div>
<div style="margin-left: 40px;">Lượt nộp </div>
<div style="margin-left: 40px;">Lượt xem </div>
<div style="margin-left: 40px;">Tình trạng tin </div>
<div style="margin-left: 40px;">Trạng thái </div>
<div style="margin-left: 60px;">Khác </div>
</div>
<div class="line" style ="margin-top: 20px;"></div>

<form id ="formtindang" name="formtindang">
<div style="display: flex; align-items: center;margin-top: 30px;">
<div>Nhân Viên Điều Dưỡng</div>
<div style ="margin-left: 50px;"><i class="fa fa-pencil" aria-hidden="true" style="color:#9A2EFE"></i></div>
...
<div style="display: flex; align-items: center;margin-top: 30px;">
<div>Loại tin:</div>
<div id="loaitin" name="loaitin" >Tin không phí </div>
<div style="margin-left:5px;"> | </div>
<div style="margin-left:5px;"> Mã tin: </div> 
<div id="matin" name="matin"  style="margin-left:5px;"> 2222222 </div> 
<div id="ngaydangtin" name="ngaydangtin" style="margin-left:5px;"> 13/03/2024</div> 
<div id="toigiannop" name="thoigiannop" style="margin-left:55px;color:red;"> Đã hết hạn </div> 
<div id="luotnop" name="luotnop" style="margin-left:55px;color:#29088A;"> 186 </div> 
<div id="luotxem" name="luotxem" style="margin-left:55px;color:#29088A;"> 300 </div> 
<div id="tinhtrang" name="" style="margin-left:55px;color:#29088A;"> Đang ẩn </div> 
<div id="trangthai" class="trangthai" name="trangthai" style="margin-left:55px;color:#29088A;"> Chờ duyệt </div> 
<div style="margin-left: 40px;">
    <button class="buttonxuatban" style=" border: 2px solid #008000; border-radius: 5px; padding: 3px 8px; font-size: 12px;">Xuất Bản</button>
</div>
<div class="roundedBox" style="margin-left:5px;">
...
<div style="display: flex; align-items: center;margin-top: 30px;color: blue; margin-left:20px;"> <a href="#">
<span class="magnifying-glass">&#128269;</span> Xem hồ sơ ứng viên phù hợp
</a>
</div>
