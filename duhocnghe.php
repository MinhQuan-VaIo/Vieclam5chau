...
<div class="cl-right-lang fr">
    ...
    <div id="body" class="footer w100 fl top-20">
       <h2 style = "text-align: center; color: blue; ">Danh Sách Các Trường Tại Hàn Quốc </h2>

       <div class="col-md-4 col-xs-12" >
      <input type="text" style="height: 50px; margin-left:20px;" class="form-control show-select" id="chose-option-diemden-empty" placeholder="Lọc Theo Tên Trường">
      ...
      <div class="col-dk-1 col-md-2 col-xs-12">
      <button id = "searchduhocnghe" class="searchduhocnghe" style = "height: 50px; weight:50%;">Tìm kiếm <i class="fa fa-search" aria-hidden="true"></i></button>
        </div>
        <div class="col-md-4 col-xs-12">
     <img src="imgs/anhtruong1.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/anhtruong2.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
     <img src="imgs/anhtruong3.jpeg" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">

     </div>
     <div class="col-md-4 col-xs-12">
        <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Trường Tại Tỉnh Gangwon </h3>
        <a href="chitiettruong.php" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>

     </div>
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Trường Tại Tỉnh Bắc Chungcheong </h3>
     ...
     <div class="col-md-4 col-xs-12">
     <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Trường Tại Tỉnh Nam Chungcheong </h3>
        <a href="" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
